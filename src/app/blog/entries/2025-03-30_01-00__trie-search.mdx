...
- Our search experience for roles and instruments is not the best. It search for a letter in the whole word.

        - For instance. if I type “h” every instrument that has the letter “h” somewhere in the name it will be returned
...
- Nodes have a map to their children, so the search
